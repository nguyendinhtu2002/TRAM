        ...
        <>
            <div className="bg-gray-100 p-5 pb-3 mt-20">
                <div className="py-2">
                    ...
                    <Slider {...settings} >
                        <div
                            ...
                            <div className="mb-4">
                                <p className="mb-2 text-base font-medium  dark:text-white">
                            ...
                            <div className="items-center justify-center space-y-4 sm:flex ">
                                <div className="code">
                                    Mã:
                        ...
                        <div
                            className="w-full p-4  bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 ml-4">
                            <div className="mb-4">
                                <p className="mb-2 text-base font-medium  dark:text-white">
                                    <strong> 200k4790</strong>
                                </p>
              ...
              <span className="font-semibold italic">
                ...
                cho phái nữ
                    ...
                    <blockquote
                        className="px-4 py-0  border-l-4 border-[#fab55a] bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
            ...
            <span className="font-semibold italic">
              Chọn vòng trầm hương phù hợp cung mệnh cho phái nữ
                ...
                <ul className="list-disc ml-5 mb-[1.3em]">
                    <li className="mb-1">
