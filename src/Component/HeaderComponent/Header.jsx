  ...
  return (
    <header className="bg-[#101628]">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white hover:text-[#fab55a]">
              Product
              <ChevronDownIcon
              ...
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-[#101628] shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-[#fab55a]-50 group-hover:bg-[#101628]">
                        <item.icon
                          className="h-6 w-6 text-gray-600 group-hover:text-gray-300"
                          aria-hidden="true"
                        />
                      </div>
                      <div className="flex-auto">
                        <a
                          href={item.href}
                          className="block font-semibold text-[#fab55a] hover:text-[#101628]"
                        >
                          {item.name}
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#101628] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
