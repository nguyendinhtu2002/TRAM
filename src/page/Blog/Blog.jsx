    ...
    return (
        <>
            ...
            <div className="container my-5 mx-auto p-5">
                <h1 className="text-center uppercase text-3xl font-bold text-justify py-3">CHÍNH SÁCH BẢO VỆ THÔNG TIN CÁ NHÂN CỦA NGƯỜI TIÊU DÙNG </h1>
                <ul className="list-disc">
                    <li className="py-3  text-justify"><p>Người Tiêu Dùng hoặc Khách hàng sẽ được yêu cầu điền đầy đủ
                        ...
                        thông tin theo mẫu có sẵn trên Website tramhuongletravn.com như: Họ và Tên, địa chỉ (nhà riêng hoặc
                    ...
                    <li className="py-3 text-justify"><p>Về cookie và đèn báo hiệu web: Cookie là những thư mục dữ
                        ...
                        sử dụng và người sử dụng Website tramhuongletravn.com, như các tuỳ chọn cho trang web hoặc thông
                        tin về giỏ hàng điện tử của họ. Những thư mục cookie cũng có thể được các công ty cung cấp
                        dịch vụ quảng cáo đã ký kết Hợp đồng với Trầm Hương Lê Trà đặt trong máy tính của Khách hàng với
                        ...
                        năng của Website tramhuongletravn.com . Để biết thêm thông tin về (cách sử dụng và không nhận)
                    ...
                    <li className="py-3 text-justify"><p>Đèn báo hiệu web: Là các sợi mã phần mềm nhỏ tượng trưng cho
                        ...
                        cáo quảng cáo, và tính cá nhân hoá. Đèn báo hiệu web mà Trầm Hương Lê Trà sử dụng chỉ để thu
                ...
                <ul className="list-decimal text-2xl font-bold">
                    ...
                    <li className="py-3 text-justify"><h2 className="uppercase font-bold text-2xl">PHẠM VI SỬ DỤNG THÔNG
                        TIN CÁ NHÂN</h2>
                        <p className="text-base font-normal">Website tramhuongletravn.com sử dụng thông tin của Người Tiêu
                            Dùng cung cấp để:</p>
                        <ul className="list-disc text-base font-normal">
                            <li>Cung cấp các dịch vụ đến Người Tiêu Dùng;</li>
                            <li>Gửi các thông báo về các hoạt động trao đổi thông tin giữa Người Tiêu Dùng và Trầm Hương Lê Trà;
                            </li>
                            ...
                            <li>Xác nhận và trao đổi thông tin về giao dịch của Người Tiêu Dùng tại Trầm Hương Lê Trà;
                            </li>
                    ...
                    <li className="py-3 text-justify">
                        ...
                        <ul className="list-disc text-base font-normal">
                            <li>Ban quản trị.</li>
                            <li>Bên thứ ba có dịch vụ tích hợp với Website tramhuongletravn.com</li>
                    ...
                    <li className="py-3 text-justify">
                        <h2 className="uppercase font-bold text-2xl">ĐỊA CHỈ CỦA ĐƠN VỊ THU THẬP VÀ QUẢN LÝ THÔNG
                            TIN</h2>
                        <p className="text-base font-normal">Công ty cổ phần Trầm Hương Lê Trà</p>
                        <ul className="list-disc text-base font-normal">
                            <li>Địa chỉ: LK 03, 04 KĐT Roman Plaza, Đại Mỗ, Nam Từ Liêm, Hà Nội</li>
                            <li>Điện thoại: 0823.611.668</li>
                            <li>Email: lekhanhtra1108@gmail.com</li>
                        </ul>
                    </li>
                    <li className="py-3 text-justify">
                        ...
                        <p className="text-base font-normal">Người Tiêu Dùng có quyền tự kiểm tra, cập nhật, điều chỉnh
                            hoặc hủy bỏ thông tin cá nhân của mình bằng cách đăng nhập vào Website tramhuongletravn.com và
