                ...
                <div className="lg:flex shadow-md my-10">
                    <div className="lg:w-3/4 bg-white px-10 py-10">
                        ...
                        <div className="flex mt-10 mb-5">
                            ...
                            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Số
                                lượng</h3>
                            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Giá
                                tiền</h3>
                            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Thành
                                tièn</h3>
                        </div>
                    ...
                    <div id="summary" className="lg:w-1/4 px-8 py-10">
                        ...
                        <div className="flex justify-between mt-10 mb-5">
                            ...
                            <span className="font-semibold text-sm">{590 - discount}$</span>
                        </div>
                        <div className="py-5">
