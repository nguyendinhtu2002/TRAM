...
function Detail() {
        ...
        return (<>
            <div className="bg-gray-100 px-5 pb-3">
                <div className="py-2">
                    ...
                    <p className="leading-relaxed text-justify ">Sản phẩm được chế tác từ loại gỗ trầm Tốc Việt Nam
                        được lấy từ
                        môi trường tự nhiên, không hề
                        bị tác động bởi bàn tay con người. Đặc biệt, xuất xứ của trầm là từ rừng Hà Tĩnh, sinh
                        trưởng tự nhiên nên chất lượng vòng tốt hơn hẳn các dòng tốc ngoài thị trường. Với màu vàng
                        nâu sẫm đặc trưng cùng những đường vân trầm xoáy, sắc nét, sản phẩm hứa hẹn sẽ mang đến tính
                        thẩm mỹ cao cùng nhiều công dụng tuyệt vời cho người đeo.
                    </p>
                    <div className="my-3">
                        <div className="w-96 mx-auto">
                            <img className=" lg:w-96" src={vong_tay} alt="Vòng tay trầm hương"/>
                        </div>
                        <div className="w-96 mx-auto bg-gray-200 py-1">
                            <p className=" text-center b-0"><span className="font-semibold italic">Vòng tay Trầm Hương Phật Di Lặc</span>
                            </p>
                        </div>
                    </div>
                    <p className="leading-relaxed text-justify ">Vòng tay Trầm Hương Phật Di Lặc với mùi thơm dịu
                        nhẹ giúp tinh thần thoải mái nhẹ nhàng sẽ giúp bé ngoan ngoãn và hiền hòa. Trầm hương thật
                        tự nhiên hấp thụ tinh hoa của đất trời còn ‘trộm vía’ giúp mau ăn chóng lớn, hoàn toàn lành
                        tính và phù hợp cho trẻ nhỏ.

                        Chất liệu vòng: Trầm Hương tự nhiên 100%, hạt tròn đều, nhẵn mịn rất an toàn cho trẻ nhỏ kết
                        hợp cùng charm bạc 925</p>
                </div>
                <div className="py-2">
                    <h2 className="font-bold text-2xl pb-1">Ý nghĩa của sự kết hợp Trầm Hương và mặt phật Di
                        Lặc</h2>
                    <p className="leading-relaxed text-justify">Đức Phật Di Lặc – hay còn gọi là “Phật Cười”, là
                        biểu tượng tuyệt
                        đối của hạnh phúc trong phong thủy, của sự vui vẻ, hoan hỉ quên hết mọi lo lắng, sầu não.
                        Theo truyền thuyết, niềm vui lớn nhất của vị Bồ Tát này là biến buồn phiền, giận dữ, áp lực
                        của con người thành hạnh phúc. Nụ cười của Phật Di Lặc mạnh tới mức luôn tỏa sáng trên khuôn
                        mặt hiền từ phúc hậu của Ngài và Ngài tới đâu thì ở đó có hạnh phúc. Ngoài ra, Phật Di Lặc
                        rất thích con nít và ngược lại, con nít cũng rất yêu quý vị Bồ Tát này nên ta thường thấy
                        hình tượng Phật Di Lặc miệng tươi cười được trẻ con đeo xung quanh.

                        Chính vì vậy, vòng Trầm Hương phối cùng mặt Phật Di Lặc là sản phẩm đã được rất nhiều cha mẹ
                        và ông bà tin mua, làm quà tặng các bé nhân dịp thôi nôi, sinh nhật, hoặc các dịp lễ với
                        mong ước: trẻ con luôn nhận được những gì tốt đẹp nhất, bé khỏe mạnh, chơi ngoan, ngủ ngon,
                        hết giật mình.</p>
                </div>
    ...
    return (<>
        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Vòng tay Trầm Hương
                            Phúc
          ...
          <span className="flex items-center">
            ...
            <p className="ml-3">Tình trạng: <span className="text-amber-500 font-bold ml-1">Còn hàng</span></p>
                        ...
                        <p className="leading-relaxed">Vòng tay Trầm Hương Phúc Bảo chính là món bảo vật thời
                            thượng,
                        ...
                        <div className="flex gap-3">
                            <button
                                className="flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Mua
                                ngay
                            </button>
                            <button
                                className="flex text-white bg-cyan-500  border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded">Add
                                to cart
                            </button>
                            <button
        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white">
            <div className="container px-5 py-12 mx-auto">
                {/*          <!-- Title --> */}
                <h4 className="text-center text-3xl font-bold text-slate-700 my-3">Đánh giá sản phẩm</h4>
