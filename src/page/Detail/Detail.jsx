                ...
                <>
                    ...
                    <section className="text-gray-700 body-font overflow-hidden bg-white">
                        ...
                        <div className="container px-5 py-12 mx-auto">
                            <div className="mb-5">
                                <h2 className="font-bold text-2xl px-6 py-3">Thông tin sản phẩm</h2>

                                <table className="container mx-auto table-auto">

                                    <tbody>
                                    <tr className="bg-gray-200">
                                        <td className="px-6 py-3">Chất liệu: <span>Trầm tốc</span></td>
                                    </tr>
                                    <tr className="bg-gray-100 ">
                                        <td className="px-6 py-3">Loại Charm: <span>bạc 925</span></td>
                                    </tr>
                                    <tr className="bg-gray-200 px-6 py-3">
                                        <td className="px-6 py-3">Nguồn gốc: <span>Trầm tốc</span></td>
                                    </tr>
                          ...
                          ×
                                        ...
                                        <div className="relative p-6 flex-auto">
                                            <form className="mb-6 " encType="">
                                                ...
                                                <div
                                                    className="py-2 mb-4 bg-white rounded-lg rounded-t-lg dark:bg-gray-800 dark:border-gray-700">
                                                    <label htmlFor="comment" className="sr-only">
                                                        Your comment
                                                    </label>
                                                    <input type="file"/>
