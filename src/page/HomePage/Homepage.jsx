        ...
        {/*    start customer rating*/}
            <div className="w-4/5 mx-auto rounded-2xl py-8 mt-8 md:flex md:gap-10 md:items-center">
                <div className="space-y-6 w-full">
                    <div>
                        <h2 className="text-white font-bold text-xl md:text-2xl lg:text-3xl">Cảm nhận khách hàng</h2>
                    </div>
                    <div>
                        <Rating
                            name="read-only"
                        ...
                        />
                        <p className="text-white text-justify leading-relaxed">Lần đầu tiên mua Vòng Tay Trầm Hương nên rất lo, vì hàng giả nhiều nhưng hữu duyên được các bạn nhân viên tư vấn nhiệt tình.
                        Rất là xúc động khi có những bạn nhân viên nhiệt tình đến vậy dù giá trị món mình mua cũng không lớn lắm. Chắc chắn sẽ ủng hộ
                            thêm cho shop. Chúc shop làm ăn ngày càng phát đạt nhé
                        </p>
                    </div>
                </div>
                <div className="">
                    <img className="rounded-[100%] " src={image_3} alt="Cảm nhận khác hanng"/>
                </div>
            </div>
        {/*    end customer rating*/}
        </div>
