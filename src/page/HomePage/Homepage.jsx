...
import image_1 from "../../images/tram_huong_1.jpg";
import image_2 from "../../images/tram_huong_2.jpg";
import image_3 from "../../images/tram_huong_3.jpg";
  ...
  return (
    <div>
      <div className="container mx-auto">
        <div id="default-carousel" className="relative w-full my-8" data-carousel="slide">
          <div className="relative h-56 overflow-hidden rounded-lg md:h-[28rem]">
